...
if not directory_path:
    raise ValueError("No DIRECTORY_PATH set in .env file")

#initialize NonogramSolver to run it, input savepath to save images of each step
test = NonogramSolver(savepath= directory_path)
#grab paths of produced images
jpeg_files = glob.glob(directory_path + "\\*.jpeg")

images = []
#putting all step images in a list
